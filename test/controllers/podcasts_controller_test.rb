...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { content: @podcast.content, description: @podcast.description, libsyn_id: @podcast.libsyn_id, published_on: @podcast.published_on, title: @podcast.title } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { content: @podcast.content, description: @podcast.description, libsyn_id: @podcast.libsyn_id, published_on: @podcast.published_on, title: @podcast.title } }
